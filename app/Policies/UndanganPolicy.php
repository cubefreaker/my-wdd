...
class UndanganPolicy
{
    ...
    {
        return $user->hasPermissionTo('View Undangan');
    }
    ...
    {
        return $user->hasPermissionTo('Create Undangan');
    }
    ...
    {
        return $user->hasPermissionTo('Update Undangan');
    }
    ...
    {
        return $user->hasPermissionTo('Delete Undangan');
    }
