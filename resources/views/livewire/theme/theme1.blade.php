        ...
        <div class="flex flex-col md:flex-row justify-center place-items-center">
          ...
          <div class="my-6 md:mx-2">
            <add-to-calendar-button
              ...
              buttonStyle="text"
              name="Wedding of Celina Willson &amp; Kevin Ruiz"
              description="Acara 'Akad &amp; Resepsi' pernikahan Celina Willson &amp; Kevin Ruiz"
          ...
          <div class="event-card w-72 h-42 p-8 flex flex-col justify-center">
            ...
            <span class="mx-auto">
              <add-to-calendar-button
                ...
                styleLight="--btn-background: var(--primary); --btn-text: var(--secondary); --font: milk-tea;"
                buttonStyle="text"
                name="Wedding of Kevin Ruiz &amp; Celina Willson"
                description="Acara 'Ngunduh Mantu' pernikahan Kevin Ruiz &amp; Celina Willson"
                options="'Apple','Google','Outlook.com','Yahoo'"
